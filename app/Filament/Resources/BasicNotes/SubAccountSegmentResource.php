...
use App\Filament\Resources\BasicNotes\SubAccountSegmentResource\Pages;
use App\Filament\Resources\BasicNotes\SubAccountSegmentResource\RelationManagers;
...
class SubAccountSegmentResource extends Resource
{
    ...
    {
        return [
            'index' => BasicNotes\SubAccountSegmentResource\Pages\ListSubAccountSegments::route('/'),
        ];
    }
}
