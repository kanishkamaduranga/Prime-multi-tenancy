...
use App\Filament\Resources\BasicNotes\DebtorResource\Pages;
use App\Filament\Resources\BasicNotes\DebtorResource\RelationManagers;
...
class DebtorResource extends Resource
{
    ...
    {
        return auth()->user()->can('Debtors_view');
    }

    public static function canCreate(): bool
    {
        return auth()->user()->can('Debtors_create');
    }

    public static function canEdit($record): bool
    {
        return auth()->user()->can('Debtors_edit');
    }

    public static function canDelete($record): bool
    {
        return auth()->user()->can('Debtors_delete');
    }
    ...
    {
        return [
            'index' => BasicNotes\DebtorResource\Pages\ListDebtors::route('/'),
        ];
    }
}
