...
use App\Filament\Resources\BasicNotes\BranchTypeResource\Pages;
use App\Filament\Resources\BasicNotes\BranchTypeResource\RelationManagers;
...
class BranchTypeResource extends Resource
{
    ...
    {
        return auth()->user()->can('BranchTypes_view');
    }

    public static function canCreate(): bool
    {
        return auth()->user()->can('BranchTypes_create');
    }

    public static function canEdit($record): bool
    {
        return auth()->user()->can('BranchTypes_edit');
    }

    public static function canDelete($record): bool
    {
        return auth()->user()->can('BranchTypes_delete');
    }
    ...
    {
        return [
            'index' => BasicNotes\BranchTypeResource\Pages\ListBranchTypes::route('/'),
        ];
    }
}
