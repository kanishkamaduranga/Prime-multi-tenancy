...
use App\Filament\Resources\BasicNotes\VehiclesRentedResource\Pages;
use App\Filament\Resources\BasicNotes\VehiclesRentedResource\RelationManagers;
...
class VehiclesRentedResource extends Resource
{
    ...
    {
        return [
            'index' => BasicNotes\VehiclesRentedResource\Pages\ListVehiclesRenteds::route('/'),
        ];
    }
}
