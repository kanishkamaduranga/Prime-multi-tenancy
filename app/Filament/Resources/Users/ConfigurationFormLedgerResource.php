...
use App\Filament\Resources\Users\ConfigurationFormLedgerResource\Pages;
use App\Filament\Resources\Users\ConfigurationFormLedgerResource\RelationManagers;
...
class ConfigurationFormLedgerResource extends Resource
{
    ...
    {
        return [
            'index' => Users\ConfigurationFormLedgerResource\Pages\ListConfigurationFormLedgers::route('/'),
        ];
    }
}
